...
public class GeorgeInstrumentation extends Instrumentation {
    private static final String TAG = "GeorgeInstrumentation";

    Instrumentation mBase;

    public GeorgeInstrumentation(Instrumentation mBase) {
        this.mBase = mBase;
    }
